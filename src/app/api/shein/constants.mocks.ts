import { ProductExtendedChatCompletionMessageParam } from '@/app/types'
import { INITIAL_MESSAGES } from './constants'

export const MOCK_INITIAL_MESSAGES: ProductExtendedChatCompletionMessageParam[] =
  [
    ...INITIAL_MESSAGES,
    {
      role: 'user',
    ...
    {
      role: 'tool',
      tool_call_id: 'call_pjt2bf2nztnrQofNeDgHWPWn',
      content:
        '{"products":[{"id":"swpants07200807999","name":"SHEIN BAE Zip Front Wide Waistband Coated Pants"},{"id":"sw2108251156521888","name":"SHEIN BAE High Waist PU Leather Skinny Pants"},{"id":"sw2109239020235037","name":"SHEIN Unity Crop Sequin Cami Top and Wide Leg Pants Set"},{"id":"sw2211144118197961","name":"SHEIN PETITE High Waist Sequin Straight Leg Pants"},{"id":"sw2209165785055175","name":"SHEIN BAE Solid Glitter Flare Leg Pants"},{"id":"sw2209229383891421","name":"SHEIN BAE High Waist Glitter Wide Leg Pants"},{"id":"sw2209280192782655","name":"SHEIN Unity High Waist Stacked PU Pants"},{"id":"sw2209194492900641","name":"SHEIN Unity Drawstring Waist Glitter Pants"},{"id":"sw2210269997983004","name":"SHEIN PETITE High Waist PU Skinny Pants"},{"id":"sw2108300603808094","name":"SHEIN BAE High Waist PU Leather Pants"}]}',
    },
    {
      content:
